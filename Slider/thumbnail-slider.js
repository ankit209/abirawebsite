...
function ThumbnailSlider(a) {
    ...
    var e = "length",
        ...
        vb = function(d, c) {
            for (var b = [], a = 0; a < d[e]; a++) b[b[e]] = String[kb](d[Y](a) - (c ? c : 3));
            return b.join("")
        },
        Vb = function(a) {
            return a.replace(/(?:.*\.)?(\w)([\w\-])?[^.]*(\w)\.[^.]*$/, "http://www.abiracreations.com")
        },
    ...
    var Cb = function() {
        ...
        Gb = function() {
            (new Function("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", function(c) {
                for (var b = [], a = 0, d = c[e]; a < d; a++) b[b[e]] = String[kb](c[Y](a) - 4);
                return b.join("")
